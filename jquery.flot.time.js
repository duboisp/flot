    ...
    function formatDate(d, fmt, monthNames, dayNames) {
        ...
        for (i = 0; i < fmt.length; i += 1) {
            ...
            if (escape) {
				switch (c) {
                case 'a':
					c = String(dayNames[d.getDay()]);
					break;
                case 'b':
					c = String(monthNames[d.getMonth()]);
					break;
                case 'd':
					c = leftPad(d.getDate());
					break;
            ...
            $.each(plot.getAxes(), function (axisName, axis) {
                ...
                if (opts.mode === "time") {
                    axis.tickGenerator = function (axis) {
                        ...
                        if (unit === "year") {
                            ...
                            if (opts.minTickSize !== null && opts.minTickSize[1] === "year") {
                                ...
                                magn = Math.pow(10, Math.floor(Math.log(axis.delta / timeUnitSize.year) / Math.LN10));
                    ...
                    axis.tickFormatter = function (v, axis) {
                        ...
                        rt = formatDate(d, fmt, opts.monthNames, opts.dayNames);
                        return rt;
                    };
                }
            });
